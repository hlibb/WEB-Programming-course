...
<div class="container">
    ...
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=3"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=4"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=5"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=6"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=7"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=8"><img
            ...
            <div class="carousel-item">
                <a href="../php/products/products.php?id=9"><img
